...
parcelHelpers.export(exports, "getCurrencyAccounts", ()=>getCurrencyAccounts);
parcelHelpers.export(exports, "getChangedCurrency", ()=>getChangedCurrency);
parcelHelpers.export(exports, "getKnownCurrwncies", ()=>getKnownCurrwncies);
parcelHelpers.export(exports, "getBanks", ()=>getBanks);
parcelHelpers.export(exports, "exchangeCurrency", ()=>exchangeCurrency);
...
function throwErr(res, data) {
    if (res.status === 404 || data === null) throw new Error("\u041F\u0440\u043E\u0438\u0437\u043E\u0448\u043B\u0430 \u043E\u0448\u0438\u0431\u043A\u0430, \u043F\u043E\u043F\u0440\u043E\u0431\u0443\u0439\u0442\u0435 \u043E\u0431\u043D\u043E\u0432\u0438\u0442\u044C \u0441\u0442\u0440\u0430\u043D\u0438\u0446\u0443 \u043F\u043E\u0437\u0436\u0435");
    if (res.status === 500) throw new Error("\u041F\u0440\u043E\u0438\u0437\u043E\u0448\u043B\u0430 \u043E\u0448\u0438\u0431\u043A\u0430, \u043F\u043E\u043F\u0440\u043E\u0431\u0443\u0439\u0442\u0435 \u043E\u0431\u043D\u043E\u0432\u0438\u0442\u044C \u0441\u0442\u0440\u0430\u043D\u0438\u0446\u0443 \u043F\u043E\u0437\u0436\u0435");
}
function catchErr(err1) {
    ...
    if (err1.name === "Error") {
        ...
        createErrorBox("Error" + err1.message);
    } else throw err1;
}
...
async function getChangedCurrency() {
    try {
...
async function getKnownCurrwncies() {
    try {
        return await fetch("http://localhost:3000/all-currencies").then((data)=>data.json());
    } catch (err1) {
        catchErr(err1);
    }
}
...
},{"./logIn":"bzDBz","./accounts":"3MoLQ","./loader":"1Ef8k","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bzDBz":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "renderLogInForm", ()=>renderLogInForm);
...
function renderLogInForm() {
    ...
    (0, _loader.createLoader)();
    const header = (0, _redom.el)("header", {
        class: "header"
    }, [
        (0, _redom.el)("div", {
            class: "container "
            ...
            (0, _redom.el)("a", {
                class: "coin__logo --coin__logo-login",
                href: "#"
            }, "Coin.")
        ])
    ]);
    ...
    (0, _redom.setChildren)(container, formContainer);
    (0, _redom.setChildren)(document.body, [
        header,
        container
    ]);
    const validation = new (0, _justValidateDefault.default)($form);
    validation.addField("#login", [
        {
            rule: "minLength",
            value: 6,
        ...
        },
        {
            validator: (value)=>{
                if (!value.includes(" ")) {
                    ...
                    return value;
                } else document.getElementById("login").classList.add("error");
            },
        ...
        },
        {
            validator: (value)=>{
                if (!value.includes(" ")) {
                    ...
                    return value;
                } else document.getElementById("pass").classList.add("error");
            },
...
},{"./mount.js":"5qTJ0","./unmount.js":"irGDu","./util.js":"84GoL","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1Ef8k":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function createLoader() {
    const mask = (0, _redom.el)("div", {
        class: "mask"
    });
    const loader = (0, _redom.el)("div", {
        class: "loader"
    });
    loader.innerHTML = (0, _svg.loaderSvg);
    mask.append(loader);
...
},{"redom":"gT5MM","./svg":"9nG4E","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9nG4E":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "greenArr", ()=>greenArr);
parcelHelpers.export(exports, "redArr", ()=>redArr);
parcelHelpers.export(exports, "loaderSvg", ()=>loaderSvg);
let greenArr = `<svg width="20" height="10" viewBox="0 0 20 10" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M20 10L10 0L0 10L20 10Z" fill="#76CA66"/>
</svg>`;
let redArr = `<svg width="20" height="10" viewBox="0 0 20 10" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M0 0L10 10L20 0H0Z" fill="#FD4E5D"/>
</svg>`;
let loaderSvg = `<svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 100 100" fill="none">
<g clip-path="url(#clip0_121_2401)">
  <path d="M14.0002 50.0005C14.0002 69.8825 30.1182 86.0005 50.0002 86.0005C69.8822 86.0005 86.0002 69.8825 86.0002 50.0005C86.0002 30.1185 69.8823 14.0005 50.0003 14.0005C45.3513 14.0005 40.9082 14.8815 36.8282 16.4865" stroke="rgba(17, 106, 204, 1)" stroke-width="8" stroke-miterlimit="10" stroke-linecap="round"/>
</g>
<defs>
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3MoLQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "renderAccount", ()=>renderAccount);
var _index = require("./index");
var _header = require("./header");
var _redom = require("redom");
var _detailAcc = require("./detailAcc");
var _loader = require("./loader");
async function renderAccount(token) {
    ...
    async function createAcc(accounts, token) {
        ...
        const accSection = (0, _redom.el)("section", {
            class: "section section-acc"
        });
        const container = (0, _redom.el)("div", {
            class: "container login-container"
        });
        const acoountsWrapper = (0, _redom.el)("div", {
            class: "accounts__wrapper"
        }, []);
        const accTitle = (0, _redom.el)("h2", {
            class: "accounst__title"
        }, "\u0412\u0430\u0448\u0438 \u0441\u0447\u0435\u0442\u0430");
        const createBtn = (0, _redom.el)("button", {
            class: "btn account__create",
            id: "create__account"
        }, "+ \u0421\u043E\u0437\u0434\u0430\u0442\u044C \u043D\u043E\u0432\u044B\u0439 \u0441\u0447\u0451\u0442");
        const group = (0, _redom.el)("div", {
            class: "accounst__group"
        }, []);
        (0, _redom.setChildren)(group, [
            accTitle
        ]);
        (0, _redom.setChildren)(acoountsWrapper, [
            group,
            createBtn
        ]);
        const $accountsList = (0, _redom.el)("ul", {
            class: "accounts__list list-reset"
        });
        for (const account of accounts){
            const thisAcc = await (0, _index.getAccount)(account.account, token);
            const accountCard = (0, _redom.el)("div", {
                class: "account__card"
            });
            const cardRight = (0, _redom.el)("div", {
                class: "account__card-right"
            });
            ...
            const cardTransaction = (0, _redom.el)("p", {
                class: "account__transaction"
            }, `\u{41F}\u{43E}\u{441}\u{43B}\u{435}\u{434}\u{43D}\u{44F}\u{44F} \u{442}\u{440}\u{430}\u{43D}\u{437}\u{430}\u{43A}\u{446}\u{438}\u{44F}: `);
            ...
            const btnWraper = (0, _redom.el)("div", {
                class: "card__wrapper-btn"
            });
            const openBtn = (0, _redom.el)("button", {
                class: "btn account__open-lnk"
            }, "\u041E\u0442\u043A\u0440\u044B\u0442\u044C");
        ...
        (0, _redom.setChildren)(wrapper, $accountsList);
        (0, _redom.setChildren)(container, [
            acoountsWrapper,
            wrapper
        ]);
        (0, _redom.setChildren)(accSection, container);
        (0, _redom.setChildren)(document.body, [
            header,
            accSection
        ]);
        document.getElementById("create__account").addEventListener("click", async (e)=>{
            e.preventDefault();
            let res = await (0, _index.createAccount)(token);
...
function createHeader(token) {
    ...
    const headerContainer = (0, _redom.el)("div", {
        class: "header__container"
    }, []);
    const headerBtns = (0, _redom.el)("div", {
        class: "header__btns"
    }, []);
    const banksBtn = (0, _redom.el)("button", {
        class: "btn header__btn bank__btn",
        id: "banks__btn"
    }, "\u0411\u0430\u043D\u043A\u043E\u043C\u0430\u0442\u044B");
    const accBtn = (0, _redom.el)("button", {
        class: "btn header__btn",
        id: "accounts__btn"
    }, "\u0421\u0447\u0435\u0442\u0430");
    const valBtn = (0, _redom.el)("button", {
        class: "btn header__btn",
        id: "val__btn"
    }, "\u0412\u0430\u043B\u044E\u0442\u0430");
    const exitBtn = (0, _redom.el)("button", {
        class: "btn header__btn ex__btn",
        id: "exit__btn"
    }, "\u0412\u044B\u0439\u0442\u0438");
    banksBtn.addEventListener("click", (e)=>{
        e.preventDefault();
        (0, _banks.renderMapOfBanks)(token);
    });
    ...
    accBtn.addEventListener("click", (e)=>{
        e.preventDefault();
        (0, _accounts.renderAccount)(token);
    });
    valBtn.addEventListener("click", (e)=>{
        e.preventDefault;
        (0, _currency.renderCurrency)(token);
    });
    (0, _redom.setChildren)(headerBtns, [
        banksBtn,
        accBtn,
        valBtn,
        exitBtn
    ]);
    (0, _redom.setChildren)(headerContainer, [
        coinLogo,
        headerBtns
    ]);
    (0, _redom.setChildren)(container, headerContainer);
    (0, _redom.setChildren)(header, container);
    return header;
}

},{"redom":"gT5MM","./logIn":"bzDBz","./accounts":"3MoLQ","./currency":"dBQ8y","./banks":"bBZFo","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dBQ8y":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _justValidate = require("just-validate");
var _justValidateDefault = parcelHelpers.interopDefault(_justValidate);
async function renderCurrency(token) {
    document.body.innerHTML = "";
    (0, _loader.createLoader)();
    const header = (0, _header.createHeader)(token);
    const section = (0, _redom.el)("section", {
        class: "section currency__section"
    });
    const container = (0, _redom.el)("div", {
        class: "container "
    });
    const title = (0, _redom.el)("h2", {
        class: "title curr__title"
    }, "\u0412\u0430\u043B\u044E\u0442\u043D\u044B\u0439 \u043E\u0431\u043C\u0435\u043D");
    const sectiionWrap = (0, _redom.el)("div", {
        class: "curr__wrapper"
    });
    const leftWrap = (0, _redom.el)("div", {
        class: "curr__wrapper-left"
    });
    ...
    (0, _redom.setChildren)(rightWrap, changeCard);
    (0, _redom.setChildren)(sectiionWrap, [
        leftWrap,
        rightWrap
    ]);
    (0, _redom.setChildren)(container, [
    ...
    (0, _redom.setChildren)(section, container);
    (0, _redom.setChildren)(document.body, [
        header,
        section
    ]);
...
async function createChangedCoinCard() {
    const chCurr = await (0, _index.getChangedCurrency)();
    const card = (0, _redom.el)("div", {
        class: "change__card"
    });
    const title = (0, _redom.el)("h3", {
        class: "change__title"
    }, "\u0418\u0437\u043C\u0435\u043D\u0435\u043D\u0438\u0435 \u043A\u0443\u0440\u0441\u043E\u0432 \u0432 \u0440\u0435\u0430\u043B\u044C\u043D\u043E\u043C \u0432\u0440\u0435\u043C\u0435\u043D\u0438");
    const ul = (0, _redom.el)("ul", {
        class: "list-reset change__ul"
    });
    let coinsArr = [];
    chCurr.onmessage = (event)=>{
        ...
        for (const i of coinsArr){
            ...
            if (ul.childNodes.length < 22) {
                // console.log("i "+ i.to);
                const li = (0, _redom.el)("li", {
                    class: "change__item"
                });
                const coinPare = (0, _redom.el)("p", {
                    class: "coin__currency"
                }, `${i.from}/${i.to}`);
                const coinBorder = (0, _redom.el)("span", {
                    class: "coin__item-border"
                });
                const coinRate = (0, _redom.el)("span", {
                    class: "coin__amount --ch_card-amount"
                }, `${i.rate}`);
                const coinSvg = (0, _redom.el)("span", {
                    class: "coin__svg"
                });
                if (i.change < 0) {
                    coinBorder.classList.add("red__border");
                    coinSvg.innerHTML = (0, _svg.redArr);
                } else {
                    coinBorder.classList.add("green__border");
                    coinSvg.innerHTML = (0, _svg.greenArr);
                }
                coinRate.append(coinSvg);
                (0, _redom.setChildren)(li, [
                    coinPare,
                    coinBorder,
                    coinRate
                ]);
...
async function createForm(token, knownCurr) {
    ...
    const frmTitle = (0, _redom.el)("h3", {
        class: "coin__formtitle"
    }, "\u041E\u0431\u043C\u0435\u043D \u0432\u0430\u043B\u044E\u0442");
    const selectWrapper = (0, _redom.el)("div", {
        class: "coin__select-wraper"
    });
    const formWrapper = (0, _redom.el)("div", {
        class: "coin__form-wraper"
    });
    const btnWrapper = (0, _redom.el)("div", {
        class: "coin__btn-wraper"
    });
    const selectGroup1 = (0, _redom.el)("div", {
        class: "coin__select-group"
    });
    const selectGroup2 = (0, _redom.el)("div", {
        class: "coin__select-group"
    });
    const selectLabelFrom = (0, _redom.el)("label", {
        class: "coin__select-label"
    }, "\u0418\u0437");
    const selectFrom = (0, _redom.el)("select", {
        class: "coin__select"
    });
    const selectLabelTo = (0, _redom.el)("label", {
        class: "coin__select-label"
    }, "\u0412");
    const selectTo = (0, _redom.el)("select", {
        class: "coin__select"
    });
    ...
    const inputGroup = (0, _redom.el)("div", {
        class: "coin__input-group"
    });
    const inputLabel = (0, _redom.el)("label", {
        class: "coin__input-label coin__select-label"
    }, "\u0421\u0443\u043C\u043C\u0430");
    const inputWrapper = (0, _redom.el)("div", {
        class: "input__wrapper"
    });
    const sumInput = (0, _redom.el)("input", {
        class: "coin__sum-input"
    });
    (0, _redom.setChildren)(inputWrapper, sumInput);
    const formBtn = (0, _redom.el)("button", {
        class: "btn coin__form-btn"
    }, "\u041E\u0431\u043C\u0435\u043D\u044F\u0442\u044C");
    const validation = new (0, _justValidateDefault.default)(form);
    validation.addField(sumInput, [
        {
            rule: "minLength",
            value: 1,
        ...
        },
        {
            validator: (value)=>{
                if (value > 0) {
                    ...
                    return value;
                } else sumInput.classList.add("error");
            },
            errorMessage: "\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u0441\u0443\u043C\u043C\u0443"
        },
        {
    ...
    (0, _redom.setChildren)(inputGroup, [
        inputLabel,
        inputWrapper
    ]);
    (0, _redom.setChildren)(selectGroup1, [
        selectLabelFrom,
        selectFrom
    ]);
    (0, _redom.setChildren)(selectGroup2, [
        selectLabelTo,
        selectTo
    ]);
    (0, _redom.setChildren)(selectWrapper, [
        selectGroup1,
        selectGroup2
    ]);
    (0, _redom.setChildren)(formWrapper, [
        selectWrapper,
        inputGroup
    ]);
    (0, _redom.setChildren)(btnWrapper, [
        formWrapper,
        formBtn
    ]);
...
},{"./index":"8lqZg","./header":"ef18b","redom":"gT5MM","./svg":"9nG4E","./loader":"1Ef8k","just-validate":"gcCDD","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gcCDD":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bBZFo":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "renderMapOfBanks", ()=>renderMapOfBanks);
var _redom = require("redom");
var _header = require("./header");
var _ = require(".");
var _loader = require("./loader");
async function renderMapOfBanks(token) {
    document.body.innerHTML = "";
    (0, _loader.createLoader)();
    const header = (0, _header.createHeader)(token);
    ...
    const section = (0, _redom.el)("section", {
        class: "section banks__section"
    });
    const title = (0, _redom.el)("h2", {
        class: "title banks__title"
    }, "\u041A\u0430\u0440\u0442\u0430 \u0431\u0430\u043D\u043A\u043E\u043C\u0430\u0442\u043E\u0432");
    const mapWrapper = (0, _redom.el)("div", {
        class: "map__wrapper"
    });
    const $map = (0, _redom.el)("div", {
        class: "banks__map",
        id: "map"
    });
    $map.style.width = "100%";
    ...
    (0, _redom.setChildren)(mapWrapper, $map);
    (0, _redom.setChildren)(container, [
        title,
        mapWrapper
    ]);
...
},{"redom":"gT5MM","./header":"ef18b",".":"8lqZg","./loader":"1Ef8k","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eWgUH":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createDetails", ()=>createDetails);
parcelHelpers.export(exports, "renderTable", ()=>renderTable);
var _index = require("./index");
var _header = require("./header");
var _redom = require("redom");
var _accounts = require("./accounts");
var _balanceDetails = require("./balanceDetails");
var _loader = require("./loader");
var _justValidate = require("just-validate");
var _justValidateDefault = parcelHelpers.interopDefault(_justValidate);
var _auto = require("chart.js/auto");
var _autoDefault = parcelHelpers.interopDefault(_auto);
async function createDetails(id, token) {
    let data = localStorage.getItem("numbsList");
    let numbsList = [];
    if (data !== "" && data !== null) numbsList = JSON.parse(data);
    document.body.innerHTML = "";
    (0, _loader.createLoader)();
    const header = (0, _header.createHeader)(token);
    ...
    const detailsWrapper = (0, _redom.el)("div", {
        class: "details__wrapper"
    });
    const title = (0, _redom.el)("h2", {
        class: "title details__title"
    }, "\u041F\u0440\u043E\u0441\u043C\u043E\u0442\u0440 \u0441\u0447\u0451\u0442\u0430");
    const returnBtn = (0, _redom.el)("button", {
        class: "btn return__btn",
        id: "ret__btn"
    }, `\u{412}\u{435}\u{440}\u{43D}\u{443}\u{442}\u{44C}\u{441}\u{44F} \u{43D}\u{430}\u{437}\u{430}\u{434}`);
    (0, _redom.setChildren)(detailsWrapper, [
        title,
        returnBtn
    ]);
    const infoWrapper = (0, _redom.el)("div", {
        class: "details__wrapper-info"
    }, [
        (0, _redom.el)("p", {
            class: "details__acc-number"
        }, `\u{2116} ${id}`),
        (0, _redom.el)("p", {
    ...
    const statWrapper = (0, _redom.el)("div", {
        class: "details__stat-wrapper"
    });
    const detailForm = (0, _redom.el)("form", {
        class: "details__form",
        id: "details__form"
    });
    const formTitle = (0, _redom.el)("h2", {
        class: "form__title form__title-details"
    }, "\u041D\u043E\u0432\u044B\u0439 \u043F\u0435\u0440\u0435\u0432\u043E\u0434");
    const firstFormGrp = (0, _redom.el)("div", {
        class: "input__group inp__group-details"
    });
    const numbLabel = (0, _redom.el)("label", {
        class: "input__label label-details"
    }, "\u041D\u043E\u043C\u0435\u0440 \u0441\u0447\u0451\u0442\u0430 \u043F\u043E\u043B\u0443\u0447\u0430\u0442\u0435\u043B\u044F");
    const numbInput = (0, _redom.el)("input", {
        class: "form__input",
        type: "text",
        id: "number__input",
        required: true
    });
    const inputWrapper1 = (0, _redom.el)("div", {
        class: "input__wrapper"
    });
    (0, _redom.setChildren)(inputWrapper1, numbInput);
    const inner = (0, _redom.el)("div", {
        class: "inner__wrapper",
        id: "inner"
    });
    (0, _redom.setChildren)(inner, inputWrapper1);
    (0, _redom.setChildren)(firstFormGrp, [
        numbLabel,
        inner
    ]);
    const secondFormGrp = (0, _redom.el)("div", {
        class: "input__group inp__group-details"
    });
    const sumLabel = (0, _redom.el)("label", {
        class: "input__label label-details"
    }, "\u0421\u0443\u043C\u043C\u0430 \u043F\u0435\u0440\u0435\u0432\u043E\u0434\u0430");
    const sumInput = (0, _redom.el)("input", {
        class: "form__input",
    ...
    const inputWrapper2 = (0, _redom.el)("div", {
        class: "input__wrapper"
    });
    (0, _redom.setChildren)(inputWrapper2, sumInput);
    const sumErr = (0, _redom.el)("div", {
        class: "error__wrapper",
        id: "err__sum"
    });
    (0, _redom.setChildren)(secondFormGrp, [
        sumLabel,
        inputWrapper2,
        sumErr
    ]);
    const formBtnDiv = (0, _redom.el)("div", {
        class: "form__wrapper"
    });
    const formBtn = (0, _redom.el)("button", {
        class: "btn form-btn form-send-btn",
        id: "form-send-btn"
    }, "\u041E\u0442\u043F\u0440\u0430\u0432\u0438\u0442\u044C");
    (0, _redom.setChildren)(formBtnDiv, formBtn);
    (0, _redom.setChildren)(detailForm, [
        formTitle,
        firstFormGrp,
        secondFormGrp,
        formBtnDiv
    ...
    chart.addEventListener("click", (e)=>{
        e.preventDefault();
        (0, _balanceDetails.balanceDetails)(id, token);
    });
    const chartTitle = (0, _redom.el)("h2", {
        class: "title chart__title"
    }, "\u0414\u0438\u043D\u0430\u043C\u0438\u043A\u0430 \u0431\u0430\u043B\u0430\u043D\u0441\u0430");
    (0, _redom.setChildren)(chartWrapper, [
        chartTitle,
        chart
    ]);
    (0, _redom.setChildren)(statWrapper, [
        detailForm,
        chartWrapper
    ]);
    const tableWrapper = (0, _redom.el)("div", {
        class: "details__wrapper-table"
    });
    ...
    const validation = new (0, _justValidateDefault.default)(detailForm);
    validation.addField("#number__input", [
        {
            rule: "minLength",
            value: 1,
        ...
        },
        {
            validator: (value)=>{
                if (value > 0) {
                    ...
                    return value;
                } else numbInput.classList.add("error");
            },
            errorMessage: "\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u043D\u043E\u043C\u0435\u0440 \u0441\u0447\u0451\u0442\u0430"
        }
    ]).addField("#sum__input", [
...
function autocomplite(numbsList, inner, input) {
    ...
    const insertMark = (str, pos, len)=>str.slice(0, pos) + '<mark class = "mark" >' + str.slice(pos, pos + len) + "</mark>" + str.slice(pos + len);
    input.addEventListener("input", (e)=>{
        e.preventDefault();
        const value = input.value.trim();
        if (!isNaN(value) && value.length > 15) {
            if (!numbsList.includes(value)) numbsList.push(value);
        }
        localStorage.setItem("numbsList", JSON.stringify(numbsList));
        const foundItems = document.querySelectorAll(".find-link");
        if (value != "") foundItems.forEach((link)=>{
...
function renderTable(transactions, id) {
    const table = (0, _redom.el)("table", {
        class: "table details__table",
        id: "details__table"
    });
    const tHead = (0, _redom.el)("thead", {
        class: "thead details__thead"
    }, [
        (0, _redom.el)("tr", {
            class: "thead__tr"
        }, [
    ...
    const tBody = (0, _redom.el)("tbody", {
        class: "tbody details__tbody",
        id: "details__tbody"
    });
    let count = 0;
    for (const transaction of transactions.slice(-10)){
        count++;
        const $tr = (0, _redom.el)("tr", {
            class: "tbody__tr"
        });
        const sendTd = (0, _redom.el)("td", {
            class: "table__td"
        }, transaction.from);
        const recTd = (0, _redom.el)("td", {
            class: "table__td"
        }, transaction.to);
        const sumTd = (0, _redom.el)("td", {
            class: "table__td --sum-td"
        });
        if (transaction.from != id) {
            sumTd.textContent = `+ ${transaction.amount} \u{20BD}`;
            sumTd.classList.add("green");
        } else if (transaction.from === id) {
            sumTd.textContent = `- ${transaction.amount} \u{20BD}`;
            sumTd.classList.add("red");
        }
        const dateTd = (0, _redom.el)("td", {
            class: "table__td --date-td"
        }, (0, _index.getDate)(transaction.date));
        $tr.append(sendTd, recTd, sumTd, dateTd);
        tBody.append($tr);
    }
    (0, _redom.setChildren)(table, [
        tHead,
        tBody
    ]);
    return table;
...
function renderChart(transactions, balance, id) {
    const canvasWrapper = (0, _redom.el)("div", {
        class: "canvas__wrapper"
    });
    canvasWrapper.style.width = "500px";
    const chart = (0, _redom.el)("canvas", {
        id: "myChart"
    });
    ...
    for (const transaction of transactions){
        ...
        switch(mm){
            case 2:
                if (transaction.from != id) febSum = febSum + transaction.amount;
                else febSum = febSum - transaction.amount;
                break;
            case 3:
                if (transaction.from != id) febSum = febSum - transaction.amount;
                else febSum = febSum + transaction.amount;
                break;
            case 1:
                if (transaction.from != id) jenSum = jenSum + transaction.amount;
                else jenSum = jenSum - transaction.amount;
                break;
            case 12:
                if (transaction.from != id) decSum = decSum + transaction.amount;
                else decSum = decSum - transaction.amount;
                break;
            case 11:
                if (transaction.from != id) novSum = novSum + transaction.amount;
                else novSum = novSum - transaction.amount;
                break;
            case 10:
                if (transaction.from != id) octSum = octSum + transaction.amount;
                else octSum = octSum - transaction.amount;
                break;
        }
    }
    ...
    new (0, _autoDefault.default)(chart, {
        type: "bar",
        data: {
...
},{"./index":"8lqZg","./header":"ef18b","redom":"gT5MM","./accounts":"3MoLQ","./balanceDetails":"iCcl1","./loader":"1Ef8k","just-validate":"gcCDD","chart.js/auto":"d8NN9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iCcl1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "balanceDetails", ()=>balanceDetails);
var _index = require("./index");
var _redom = require("redom");
var _header = require("./header");
var _detailAcc = require("./detailAcc");
...
var _auto = require("chart.js/auto");
var _autoDefault = parcelHelpers.interopDefault(_auto);
async function balanceDetails(id, token) {
    document.body.innerHTML = "";
    (0, _loader.createLoader)();
    const header = (0, _header.createHeader)(token);
    let thisAcc = await (0, _index.getAccount)(id, token);
    ...
    returnBtn.addEventListener("click", (e)=>{
        e.preventDefault();
        (0, _detailAcc.createDetails)(id, token);
    });
    (0, _redom.setChildren)(detailsWrapper, [
        title,
        returnBtn
    ...
    const dynamicChartWrapper = (0, _redom.el)("div", {
        class: "chart__wrapper --balance__chart-wrapper"
    });
    const dynChart = renderChart(thisAcc.payload.transactions, thisAcc.payload.balance, id);
    const dynChartTitle = (0, _redom.el)("h2", {
        class: "title chart__title"
    }, "\u0414\u0438\u043D\u0430\u043C\u0438\u043A\u0430 \u0431\u0430\u043B\u0430\u043D\u0441\u0430");
    (0, _redom.setChildren)(dynamicChartWrapper, [
        dynChartTitle,
        dynChart
    ]);
    const transactionsChartWrapper = (0, _redom.el)("div", {
        class: "chart__wrapper --balance__chart-wrapper"
    });
    const trChart = renderChart(thisAcc.payload.transactions, thisAcc.payload.balance, id);
    const trChartTitle = (0, _redom.el)("h2", {
        class: "title chart__title"
    }, "\u0421\u043E\u043E\u0442\u043D\u043E\u0448\u0435\u043D\u0438\u0435 \u0432\u0445\u043E\u0434\u044F\u0449\u0438\u0445 \u0438\u0441\u0445\u043E\u0434\u044F\u0449\u0438\u0445 \u0442\u0440\u0430\u043D\u0437\u0430\u043A\u0446\u0438\u0439");
    (0, _redom.setChildren)(transactionsChartWrapper, [
        trChartTitle,
        trChart
    ]);
    const tableWrapper = (0, _redom.el)("div", {
        class: "details__wrapper-table --balance__table"
    });
    const tableTitle = (0, _redom.el)("h2", {
        class: "title table__title "
    }, "\u0418\u0441\u0442\u043E\u0440\u0438\u044F \u043F\u0435\u0440\u0435\u0432\u043E\u0434\u043E\u0432");
    const $table = (0, _detailAcc.renderTable)(thisAcc.payload.transactions, id);
    tableWrapper.append(tableTitle, $table);
    (0, _redom.setChildren)(container, [
        detailsWrapper,
        infoWrapper,
    ...
    for (const transaction of transactions){
        ...
        switch(mm){
            ...
            case 10:
                ...
                break;
            case 9:
                if (transaction.from != id) sepSum = sepSum + transaction.amount;
                else sepSum = sepSum - transaction.amount;
                break;
            case 8:
                if (transaction.from != id) augSum = augSum + transaction.amount;
                else augSum = augSum - transaction.amount;
                break;
            case 7:
                if (transaction.from != id) julSum = julSum + transaction.amount;
                else julSum = julSum - transaction.amount;
                break;
            case 6:
                if (transaction.from != id) junSum = junSum + transaction.amount;
                else junSum = junSum - transaction.amount;
                break;
            case 5:
                if (transaction.from != id) maySum = maySum + transaction.amount;
                else maySum = maySum - transaction.amount;
                break;
            case 4:
                if (transaction.from != id) aprSum = aprSum + transaction.amount;
                else aprSum = aprSum - transaction.amount;
                break;
        }
    }
    console.log("mar: " + marSum, "feb: " + febSum, "jen: " + jenSum, "dec: " + decSum, "nov: " + novSum, "oct: " + octSum);
...
},{"./index":"8lqZg","redom":"gT5MM","./header":"ef18b","./detailAcc":"eWgUH","./loader":"1Ef8k","chart.js/auto":"d8NN9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"d8NN9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["4rkIz","8lqZg"], "8lqZg", "parcelRequire10c2")
